...
public class MovieDatabase {
    ...
    private static final String USER = System.getenv("MYSQL_USER");  // TODO set this environment variable
    private static final String PASS = System.getenv("MYSQL_PASSWORD");   //todo set this environment variable too
    ...
    final static String MOVIE_TABLE_NAME = "movie_reviews";
    
    //A primary key is needed to allow updates to the database on modifications to ResultSet
    final static String PK_COLUMN = "id";             //Primary key column. Each movie will have a unique ID.
    final static String TITLE_COLUMN = "title";
    final static String YEAR_COLUMN = "year_released";
    final static String RATING_COLUMN = "rating";
    ...
    static void addTestData() throws SQLException{
